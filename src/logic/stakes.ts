...
export interface Stake {
  /** Signed change to the life count. Negative on a wrong answer. */
  lives: number;
  score: number;
  headline: string;
  detail: string;
    ...
    detail:
      tier === 3
        ...
        : tier === 2
          ...
          : "Wrong. That one came straight off the rack.",
    tone: "bad",
